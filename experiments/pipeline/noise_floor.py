...
at the old cadence it is refused by `batch_freeze.check_freeze_cadence` (fps-oqz) rather
than leaving freeze.json and noise_floor.json declaring different cadences. Freeze a new
batch at the new cadence instead — see docs/CONVENTIONS.md.
